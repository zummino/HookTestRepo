...
public class Test_Robula{
  ...
  public void test_loc_Robula_release_1_1() throws Exception{
    ...
    driver.findElement(By.xpath("//input[@formcontrolname='firstName']")).sendKeys("mario");
    ...
    driver.findElement(By.xpath("//input[@formcontrolname='lastName']")).sendKeys("rossi");
    ...
    driver.findElement(By.xpath("//input[@formcontrolname='email']")).sendKeys("ciao@ciao.com");
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    driver.findElement(By.xpath("//button[@class='btn btn-warning']")).click();
    driver.get("http://localhost:3001/");
    Thread.sleep(5000);
    assertEquals("4",driver.findElement(By.xpath("//div[@class='number']")).getText());
    assertEquals("rossi",driver.findElement(By.xpath("//tr[4]/td[3]")).getText());
  }
