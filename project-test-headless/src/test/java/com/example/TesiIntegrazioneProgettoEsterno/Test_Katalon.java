...
private static StringBuffer verificationErrors = new StringBuffer();
  ...
  public void test_loc_Katalon_release_1_1() throws Exception{
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='First Name'])[1]/following::input[1]")).sendKeys("mario");
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Last Name'])[1]/following::input[1]")).sendKeys("rossi");
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Email'])[1]/following::input[1]")).sendKeys("ciao@ciao.com");
    ...
    assertEquals("rossi",driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='mario'])[1]/following::td[1]")).getText());
  }
